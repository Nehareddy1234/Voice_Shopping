...
var require_lucide_react = __commonJS({
  "node_modules/lucide-react/dist/cjs/lucide-react.js"(exports2) {
    ...
    var Apple2 = createLucideIcon("Apple", [
      [
        "path",
        {
    ...
    var Baby2 = createLucideIcon("Baby", [
    ...
    var Beef2 = createLucideIcon("Beef", [
    ...
    var Coffee2 = createLucideIcon("Coffee", [
    ...
    var Cookie2 = createLucideIcon("Cookie", [
    ...
    var Globe2 = createLucideIcon("Globe", [
      ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ...
    var Heart2 = createLucideIcon("Heart", [
      [
        "path",
        {
          d: "M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",
    ...
    var History2 = createLucideIcon("History", [
    ...
    var Leaf2 = createLucideIcon("Leaf", [
      [
        "path",
        {
    ...
    var Lightbulb2 = createLucideIcon("Lightbulb", [
      [
        "path",
        {
    ...
    var ListChecks2 = createLucideIcon("ListChecks", [
    ...
    var MicOff2 = createLucideIcon("MicOff", [
      ["line", { x1: "2", x2: "22", y1: "2", y2: "22", key: "a6p6uj" }],
    ...
    var Milk2 = createLucideIcon("Milk", [
      ["path", { d: "M8 2h8", key: "1ssgc1" }],
      [
        "path",
        {
    ...
    var Minus2 = createLucideIcon("Minus", [["path", { d: "M5 12h14", key: "1ays0h" }]]);
    ...
    var PawPrint2 = createLucideIcon("PawPrint", [
    ...
    var Plus2 = createLucideIcon("Plus", [
      ["path", { d: "M5 12h14", key: "1ays0h" }],
      ["path", { d: "M12 5v14", key: "s699le" }]
    ]);
    ...
    var Snowflake2 = createLucideIcon("Snowflake", [
      ["line", { x1: "2", x2: "22", y1: "12", y2: "12", key: "1dnqot" }],
      ["line", { x1: "12", x2: "12", y1: "2", y2: "22", key: "7eqyqh" }],
    ...
    var Trash22 = createLucideIcon("Trash2", [
      ["path", { d: "M3 6h18", key: "d0wm0j" }],
    ...
    var Wheat2 = createLucideIcon("Wheat", [
    ...
    exports2.Apple = Apple2;
    exports2.AppleIcon = Apple2;
    ...
    exports2.Coffee = Coffee2;
    exports2.CoffeeIcon = Coffee2;
    exports2.Cog = Cog;
    ...
    exports2.Lightbulb = Lightbulb2;
    exports2.LightbulbIcon = Lightbulb2;
    ...
    exports2.ListChecks = ListChecks2;
    exports2.ListChecksIcon = ListChecks2;
    ...
    exports2.LucideHistory = History2;
    ...
    exports2.LucideLightbulb = Lightbulb2;
    ...
    exports2.LucideListChecks = ListChecks2;
    ...
    exports2.LucideMic = Mic2;
    exports2.LucideMic2 = MicVocal;
    exports2.LucideMicOff = MicOff2;
    ...
    exports2.LucidePawPrint = PawPrint2;
    ...
    exports2.LucideSnowflake = Snowflake2;
    ...
    exports2.MicIcon = Mic2;
    exports2.MicOff = MicOff2;
    exports2.MicOffIcon = MicOff2;
    ...
    exports2.PawPrint = PawPrint2;
    exports2.PawPrintIcon = PawPrint2;
    ...
    exports2.Snowflake = Snowflake2;
    exports2.SnowflakeIcon = Snowflake2;
    exports2.Sofa = Sofa;
    ...
    exports2.Wheat = Wheat2;
    exports2.WheatIcon = Wheat2;
...
var LANGUAGES = [
  { code: "en-US", short: "en", label: "English", flag: "\u{1F1FA}\u{1F1F8}" },
  { code: "es-ES", short: "es", label: "Espa\xF1ol", flag: "\u{1F1EA}\u{1F1F8}" },
  { code: "fr-FR", short: "fr", label: "Fran\xE7ais", flag: "\u{1F1EB}\u{1F1F7}" },
  { code: "hi-IN", short: "hi", label: "\u0939\u093F\u0928\u094D\u0926\u0940", flag: "\u{1F1EE}\u{1F1F3}" },
  { code: "de-DE", short: "de", label: "Deutsch", flag: "\u{1F1E9}\u{1F1EA}" }
];
var LANGUAGE_INDEX = Object.fromEntries(LANGUAGES.map((entry) => [entry.short, entry]));
var DEPARTMENTS = [
  { id: "produce", label: "Fresh Produce", icon: import_lucide_react.Apple, tint: "bg-green-100 text-green-800" },
  { id: "dairy-eggs", label: "Dairy & Eggs", icon: import_lucide_react.Milk, tint: "bg-blue-100 text-blue-800" },
  { id: "meat-seafood", label: "Meat & Seafood", icon: import_lucide_react.Beef, tint: "bg-red-100 text-red-800" },
  { id: "bakery", label: "Bakery & Bread", icon: import_lucide_react.Wheat, tint: "bg-amber-100 text-amber-800" },
  { id: "pantry", label: "Pantry Staples", icon: import_lucide_react.Package, tint: "bg-orange-100 text-orange-800" },
  { id: "frozen", label: "Frozen Foods", icon: import_lucide_react.Snowflake, tint: "bg-cyan-100 text-cyan-800" },
  { id: "snacks", label: "Snacks & Sweets", icon: import_lucide_react.Cookie, tint: "bg-yellow-100 text-yellow-800" },
  { id: "beverages", label: "Beverages", icon: import_lucide_react.Coffee, tint: "bg-teal-100 text-teal-800" },
  { id: "personal-care", label: "Personal Care", icon: import_lucide_react.Sparkles, tint: "bg-pink-100 text-pink-800" },
  { id: "household", label: "Household Essentials", icon: import_lucide_react.Home, tint: "bg-violet-100 text-violet-800" },
  { id: "baby", label: "Baby Care", icon: import_lucide_react.Baby, tint: "bg-rose-100 text-rose-800" },
  { id: "pet", label: "Pet Supplies", icon: import_lucide_react.PawPrint, tint: "bg-lime-100 text-lime-800" }
];
var DEPARTMENT_INDEX = Object.fromEntries(DEPARTMENTS.map((entry) => [entry.id, entry]));
var CATALOG = [
  // ---- Fresh Produce ----
...
var normalize = (s) => String(s || "").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").normalize("NFC").replace(/[^\p{L}\p{M}\p{N}\s]/gu, " ").replace(/\s+/g, " ").trim();
...
var ACTION_VERBS = {
  add: {
    ...
    es: ["a\xF1ade", "anade", "agrega", "a\xF1adir", "agregar", "pon", "suma"],
    ...
    de: ["f\xFCge", "fug", "f\xFCgen", "fugen", "hinzuf\xFCgen", "hinzufugen", "pack", "nimm"]
  },
  remove: {
    en: ["remove", "delete", "take off", "drop", "get rid of"],
    es: ["quita", "quitar", "elimina", "eliminar", "saca", "borra"],
    fr: ["retire", "retirer", "enleve", "enl\xE8ve", "supprime", "supprimer"],
    hi: ["hatao", "\u0939\u091F\u093E\u0913", "nikalo", "\u0928\u093F\u0915\u093E\u0932\u094B", "remove karo", "hata do", "\u0939\u091F\u093E \u0926\u094B"],
    de: ["entferne", "entfernen", "streich", "streiche", "l\xF6sche", "losche"]
  },
  search: {
    en: ["search", "find", "show", "look for", "browse"],
    es: ["busca", "buscar", "muestra", "ensename", "ense\xF1a"],
  ...
  clear: {
    ...
    es: ["vaciar", "vacia", "vac\xEDa", "limpia"],
    fr: ["vide", "vider", "efface", "effacer"],
    hi: ["khali karo", "khali", "saaf karo", "\u0938\u093E\u092B \u0915\u0930\u094B", "\u0916\u093E\u0932\u0940 \u0915\u0930\u094B"],
    de: ["leere", "leeren", "l\xF6sche alles", "losche alles"]
  }
};
var NUMBER_WORDS = {
  zero: 0,
...
var UNIT_LOOKUP = Object.fromEntries(
  UNIT_WORDS.flatMap((group) => group.words.map((word) => [word, group.canonical]))
);
var numberPattern = Object.keys(NUMBER_WORDS).sort((a, b) => b.length - a.length).join("|");
var unitPattern = Object.keys(UNIT_LOOKUP).sort((a, b) => b.length - a.length).join("|");
var qtyUnitRegex = new RegExp(
  `(?<![\\p{L}\\p{N}])(\\d+(?:\\.\\d+)?|${numberPattern})(?:\\s*x\\s*)?\\s*(${unitPattern})?(?![\\p{L}\\p{N}])\\s*(?:(?:of|de|von)\\s+)?`,
  "u"
);
var UNDER_PHRASES = "(?:under|below|less than|max(?:imum)?|cheaper than|menos de|por menos de|maximo|sous|moins de|maximum|unter|billiger als|maximal|se kam|kam me|mein)";
function parseIntent(rawText, lang = "en") {
  ...
  const mapped = tokens.map((token) => {
    ...
    if (STOPWORDS.has(token) || NUMBER_WORDS[token] !== void 0 || UNIT_LOOKUP[token]) return null;
    return token;
  });
...
var SCRIPT_HINTS = [{ short: "hi", regex: /[\u0900-\u097F]/ }];
var languageMeta = (short, source = "default") => {
  const entry = LANGUAGE_INDEX[short];
  if (!entry) return { short: "en", code: "en-US", label: "English", flag: "\u{1F1FA}\u{1F1F8}", source };
  return { short: entry.short, code: entry.code, label: entry.label, flag: entry.flag, source };
};
var lexiconScore = (normText, short) => {
...
function detectLanguage(text, fallbackShort = "en") {
...
var tokenize = (query) => String(query || "").toLowerCase().split(/[\s.,;:!?¿¡'"’“”()\[\]]+/).filter(Boolean);
function searchCatalog(rawQuery, { maxPrice = null } = {}) {
...
function findSubstitute(product) {
...
var TTS_PHRASES = {
  ...
  es: {
    add: [(name) => `\xA1Listo, agregu\xE9 ${name}!`, (name) => `\xA1Anotado! ${name} est\xE1 en la lista.`],
    addRestock: [(name) => `\xA1Entendido! Agregu\xE9 ${name} antes de que te quedes sin nada.`, (name) => `\xA1Voy! Reponiendo ${name}.`],
    addMulti: [() => "\xA1Hecho, agregu\xE9 todo!", () => "\xA1Genial, todo en la lista!"],
    remove: [(name) => `\xA1Puf! Quit\xE9 ${name} de la lista.`, (name) => `${name} fuera de la lista.`],
    cleared: [() => "\xA1Lista vaciada!", () => "\xA1Todo limpio!"],
    notFound: [() => "No encontr\xE9 eso, \xBFpuedes repetirlo?", () => "Eso no est\xE1 en la tienda."]
  },
  fr: {
    add: [(name) => `C'est bon, j'ai ajout\xE9 ${name} !`, (name) => `${name} est sur la liste !`],
    addRestock: [(name) => `Bien jou\xE9, j'ai ajout\xE9 ${name} avant la panne s\xE8che !`, (name) => `Je m'en occupe, je rajoute ${name}.`],
    addMulti: [() => "Voil\xE0, tout est ajout\xE9 !", () => "Parfait, tout est sur la liste."],
    remove: [(name) => `Pouf ! J'ai retir\xE9 ${name} de la liste.`, (name) => `${name}, c'est enlev\xE9 !`],
    cleared: [() => "La liste est vid\xE9e !", () => "Tout est nettoy\xE9 !"],
    notFound: [() => "Je n\u2019ai pas trouv\xE9 \xE7a, tu peux reformuler ?", () => "\xC7a n\u2019existe pas en magasin."]
  },
  hi: {
  ...
  de: {
    add: [(name) => `Alles klar, ${name} ist auf der Liste!`, (name) => `Erledigt, ${name} hinzugef\xFCgt!`],
    addRestock: [(name) => `Verstanden, ${name} hinzugef\xFCgt, bevor alles leer ist!`, (name) => `Ich k\xFCmmere mich darum \u2014 ${name} kommt auf die Liste.`],
    addMulti: [() => "Fertig, alles hinzugef\xFCgt!", () => "Super, alles landet auf deiner Liste."],
    remove: [(name) => `Puff! ${name} von der Liste entfernt.`, (name) => `${name} ist raus aus der Liste!`],
    cleared: [() => "Die Liste ist leer!", () => "Alles gel\xF6scht!"],
    notFound: [() => "Das habe ich nicht gefunden \u2014 sagst du es anders?", () => "Das gibt es leider nicht im Laden."]
  }
};
var lastPhrasePick = {};
function pickPhrase(short, category, ...args) {
...
function detectRestockContext(text, short = "en") {
  const norm = normalize(text);
  if (!norm) return false;
  const hints = [...RESTOCK_HINTS[short] || [], ...RESTOCK_HINTS.en];
  return hints.some((hint) => norm.includes(normalize(hint)));
}
var MULTI_ITEM_SPLIT = /(?:,|\band\b|\by\b|\bet\b|\bund\b|और|\baur\b)/i;
function splitMultiItems(text) {
  return String(text || "").split(MULTI_ITEM_SPLIT).map((part) => part.trim()).filter(Boolean);
}
var detectMultiItem = (text) => splitMultiItems(text).length > 1;

// scripts/verify-logic.jsx
var failures = 0;
...
var usedCategories = new Set(CATALOG.map((item) => item.category));
check("all 12 departments populated", usedCategories.size, 12);
var schemaKeys = ["id", "name", "category", "price", "unit", "brand", "isOrganic", "inStock", "season", "substitutes"];
...
var r = parseIntent("add 2 bottles of almond milk", "en");
...
r = parseIntent("A\xF1adir leche", "es");
...
check("detect DE", detectLanguage("f\xFCge milch hinzu", "en").short, "de");
...
var organicApples = searchCatalog("organic apples", { maxPrice: 5 });
...
var wholeMilk = CATALOG.find((item) => item.id === "whole-milk");
var sub = findSubstitute(wholeMilk);
